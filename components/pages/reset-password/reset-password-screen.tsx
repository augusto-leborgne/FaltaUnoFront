        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl xs:rounded-2xl sm:rounded-3xl shadow-xl p-6 xs:p-8 sm:p-10 text-center">
            ...
            <Link
              ...
              className="inline-block bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-semibold py-3 xs:py-3.5 min-h-[44px] xxs:min-h-[46px] xs:min-h-[48px] sm:min-h-[50px] md:min-h-[52px] px-5 xs:px-6 rounded-lg xs:rounded-xl transition-colors touch-manipulation active:scale-[0.98]"
            >
