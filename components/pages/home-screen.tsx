...
export function HomeScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/5 via-background to-background flex flex-col">
      {/* HERO HEADER */}
      <div className="pt-10 sm:pt-16 pb-4 sm:pb-8 px-3 sm:px-6">
        <div className="flex items-center justify-between mb-3 sm:mb-6">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
            <button
              ...
              className="relative p-2 sm:p-2.5 rounded-full bg-white shadow-md hover:shadow-lg transition-all duration-200 touch-manipulation active:scale-95"
            >
              <Bell className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
              {notificationCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] sm:min-w-[20px] sm:h-5 bg-red-500 text-white text-[10px] sm:text-xs font-bold rounded-full flex items-center justify-center px-1 sm:px-1.5 shadow-md">
            ...
            <UserAvatar 
              ...
              className="w-9 h-9 sm:w-12 sm:h-12 cursor-pointer ring-2 ring-white shadow-md hover:ring-primary transition-all duration-200"
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-4 mb-4 sm:mb-6">
          <button
            ...
            className="bg-gradient-to-r from-primary to-primary/90 active:from-primary/80 active:to-primary/70 text-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 shadow-lg active:shadow-md transition-all duration-200 touch-manipulation active:scale-[0.97] group"
          >
            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
              <Plus className="w-5 h-5 sm:w-7 sm:h-7 group-active:rotate-90 transition-transform duration-300" />
            </div>
            <div className="text-left">
              <div className="font-bold text-sm sm:text-lg mb-0.5 sm:mb-1">Crear Partido</div>
              <div className="text-[10px] sm:text-sm text-white/80 leading-tight">Organiza un nuevo partido</div>
            </div>
          </button>

          <button
            onClick={handleViewAllMatches}
            className="bg-gradient-to-r from-secondary to-secondary/90 active:from-secondary/80 active:to-secondary/70 text-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 shadow-lg active:shadow-md transition-all duration-200 touch-manipulation active:scale-[0.97] group"
          >
            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
              <Users className="w-5 h-5 sm:w-7 sm:h-7 group-active:scale-110 transition-transform duration-300" />
            </div>
            <div className="text-left">
              <div className="font-bold text-sm sm:text-lg mb-0.5 sm:mb-1">Buscar Partidos</div>
              <div className="text-[10px] sm:text-sm text-white/80 leading-tight">Únete a un partido</div>
            </div>
          </button>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4">
          <div className="bg-white rounded-lg sm:rounded-2xl p-2.5 sm:p-4 text-center shadow-md border border-primary/10">
            ...
            <div className="text-[9px] sm:text-xs text-muted-foreground font-medium leading-tight">Activos</div>
          </div>
          <div className="bg-white rounded-lg sm:rounded-2xl p-2.5 sm:p-4 text-center shadow-md border border-primary/10">
            <div className="flex items-center justify-center mb-1 sm:mb-2">
            ...
            <div className="text-[9px] sm:text-xs text-muted-foreground font-medium leading-tight">Partidos</div>
          </div>
          <div className="bg-white rounded-lg sm:rounded-2xl p-2.5 sm:p-4 text-center shadow-md border border-primary/10">
            <div className="flex items-center justify-center mb-1 sm:mb-2">
            ...
            <div className="text-[9px] sm:text-xs text-muted-foreground font-medium leading-tight">Usuarios</div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0">
                <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-600" />
              </div>
              <h2 className="text-base sm:text-xl font-bold text-foreground">Por calificar</h2>
            </div>
            <Badge className="bg-orange-100 text-orange-800 text-xs sm:text-sm font-semibold px-2 sm:px-3 py-0.5 sm:py-1">
              ...
              >
                <div className="flex items-start justify-between mb-2 sm:mb-3">
                  <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                    <Badge className="bg-orange-100 text-orange-800 text-[10px] sm:text-xs font-semibold">{review.tipo_partido}</Badge>
                    <Badge className="bg-red-100 text-red-800 text-[10px] sm:text-xs font-semibold">Pendiente</Badge>
                  </div>
                  <Star className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 fill-orange-600 flex-shrink-0 animate-pulse" />
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-foreground mb-0.5 sm:mb-1 text-xs sm:text-base leading-tight">{review.fecha}</h3>
                    <p className="text-[11px] sm:text-sm text-muted-foreground mb-1.5 sm:mb-2 flex items-center gap-1 truncate">
      ...
      {/* PRÓXIMOS PARTIDOS */}
      <div className="px-3 sm:px-6 py-3 sm:py-6 pb-20 sm:pb-24">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
              <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" />
            </div>
            <h2 className="text-base sm:text-xl font-bold text-foreground">Próximos partidos</h2>
          </div>
          <Button
            onClick={handleViewAllMatches}
            variant="outline"
            size="sm"
            className="bg-transparent border-2 border-primary text-primary active:bg-primary active:text-white font-semibold transition-all duration-200 text-xs sm:text-sm px-2.5 sm:px-3 h-8 sm:h-9"
          >
            Ver todos
          </Button>
        </div>
        ...
        {upcomingMatches.length > 0 ? (
          <div className="space-y-2.5 sm:space-y-3">
            {upcomingMatches.map((match) => (
              ...
              >
                <div className="flex items-start justify-between mb-2 sm:mb-3">
                  <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                    <Badge className="bg-primary/10 text-primary active:bg-primary/20 font-semibold text-[10px] sm:text-xs">
                      {match.tipo_partido}
                    </Badge>
                    <Badge
                  ...
                  <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground group-active:text-primary transition-colors flex-shrink-0" />
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg sm:rounded-xl flex items-center justify-center shadow-sm flex-shrink-0">
                    <Calendar className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-foreground mb-0.5 sm:mb-1 text-xs sm:text-base leading-tight">
                      {match.fecha} • {match.hora}
                    </h3>
                    <p className="text-[11px] sm:text-sm text-muted-foreground mb-2 sm:mb-3 flex items-center gap-1 truncate">
                      <MapPin className="w-3 h-3 flex-shrink-0" />
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        ...
                        <span className="text-[10px] sm:text-xs text-muted-foreground hidden sm:inline">jugadores</span>
                      </div>
          ...
          <div className="text-center py-8 sm:py-12 bg-white rounded-xl sm:rounded-2xl border-2 border-dashed border-border">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2 px-4">No tienes partidos próximos</h3>
            <p className="text-muted-foreground mb-4 sm:mb-6 text-xs sm:text-sm px-4">¡Es hora de unirte a un partido o crear uno nuevo!</p>
            <div className="flex flex-col gap-2.5 sm:gap-3 justify-center items-stretch px-4 sm:px-6">
              <Button
                onClick={handleViewAllMatches}
                className="bg-gradient-to-r from-primary to-primary/90 active:from-primary/80 active:to-primary/70 text-white font-semibold shadow-lg active:shadow-md transition-all duration-200 w-full h-11 sm:h-auto"
              >
              ...
              <Button
                onClick={handleCreateMatch}
                variant="outline"
                className="border-2 border-primary text-primary active:bg-primary active:text-white font-semibold transition-all duration-200 w-full h-11 sm:h-auto"
              >
