// components/pages/match/match-detail.tsx
"use client"
    ...
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">{error || "Partido no encontrado"}</h2>
          <p className="text-gray-600">{error ? "Por favor intenta nuevamente" : "El partido que buscas no existe"}</p>
        </div>
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="pt-16 pb-6 px-6 border-b border-gray-100">
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleShareMatch} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
