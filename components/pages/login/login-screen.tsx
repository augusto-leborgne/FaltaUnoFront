    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white">
      ...
      <div className="w-full max-w-md px-4 sm:px-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <div>
            <label htmlFor="login-password" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Contraseña</label>
            <Input
              id="login-password"
              name="password"
              type="password"
          ...
          <div className="text-right">
            <button
              ...
              className="text-xs sm:text-sm text-green-600 active:text-green-700 font-medium"
            >
          ...
          {error && (
            <div className="text-xs sm:text-sm text-red-600 mt-2">{error}</div>
          )}
        ...
        <div className="flex items-center my-4 sm:my-6">
          ...
          <span className="px-2 sm:px-3 text-xs uppercase tracking-wider text-gray-400">o continúa con</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
