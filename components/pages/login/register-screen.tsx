    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white">
      <div className="w-full max-w-md px-4 sm:px-6">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Crear cuenta</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Regístrate para organizar y sumarte a partidos</p>
        </div>

        {error && (
          <div className="mb-3 sm:mb-4 p-3 sm:p-4 bg-red-50 border border-red-200 rounded-xl sm:rounded-2xl text-red-600 text-xs sm:text-sm">
            {error}
          </div>
        )}

        {/* Formulario */}
        <form onSubmit={handleEmailRegistration} className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
          <div>
            <label htmlFor="register-email" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
            ...
            <Input
              ...
              required
              disabled={isLoading}
              className={`rounded-xl sm:rounded-2xl py-2.5 sm:py-3 text-sm sm:text-base ${fieldErrors.email ? 'border-red-500' : ''}`}
              autoComplete="email"
            />
            {fieldErrors.email && (
          ...
          <div>
            <label htmlFor="register-password" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Contraseña</label>
            <Input
              ...
              minLength={8}
              className={`rounded-xl sm:rounded-2xl py-2.5 sm:py-3 text-sm sm:text-base ${fieldErrors.password ? 'border-red-500' : ''}`}
            />
          ...
          <div>
            <label htmlFor="register-confirm-password" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Confirmar contraseña</label>
            <Input
              ...
              autoComplete="new-password"
              minLength={8}
              className={`rounded-xl sm:rounded-2xl py-2.5 sm:py-3 text-sm sm:text-base ${fieldErrors.confirmPassword ? 'border-red-500' : ''}`}
            />
          ...
          <Button 
            ...
            className="w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl text-sm sm:text-base"
          >
        ...
        <div className="flex items-center my-4 sm:my-6">
          ...
          <span className="px-2 sm:px-3 text-xs uppercase tracking-wider text-gray-400">o regístrate con</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>

        {/* Botones sociales */}
        <div className="grid grid-cols-1 gap-2 sm:gap-3">
          <Button onClick={() => handleSocialAuth("google")} variant="outline" className="w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl text-sm sm:text-base">
          ...
          <Button 
            ...
            variant="outline" 
            className="w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl opacity-50 cursor-not-allowed text-sm sm:text-base"
            disabled
          >
